...
\newlength{\colgap}   \setlength{\colgap}{7mm}   % horizontaler Spaltenabstand
\newlength{\rowgap}   \setlength{\rowgap}{8mm}   % vertikaler Zeilenabstand

% Box-Stil (kannst du natürlich anpassen)
\tikzset{
  promptbox/.style={
    draw,
    rounded corners=3pt,
...
% Breiten (müssen zusammen mit \colgap < \linewidth bleiben!)
\newlength{\bigboxwidth} \setlength{\bigboxwidth}{0.57\linewidth}
\newlength{\boxwidth}    \setlength{\boxwidth}{0.27\linewidth}
